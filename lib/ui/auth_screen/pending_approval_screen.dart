...
class PendingApprovalScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<DriverUserModel?>(
  ...
  Widget _buildPendingView(BuildContext context, DarkThemeProvider themeChange, DriverUserModel user) {
    return SafeArea(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "Thank you for submitting your information! Our team is reviewing your application and documents.".tr,
              style: GoogleFonts.poppins(
                fontSize: 16,
            ...
            Text(
              "We'll notify you once your application is approved. This usually takes 24-48 hours.".tr,
              style: GoogleFonts.poppins(
                fontSize: 14,
                color: Colors.grey[600],
                height: 1.4,
  ...
  Widget _buildRejectedView(BuildContext context, DarkThemeProvider themeChange) {
    return SafeArea(
      child: Padding(
        padding: const EdgeInsets.all(20),
        child: Column(
          ...
          children: [
            ...
            Text(
              "Unfortunately, your application has been rejected. Please contact our support team for more information.".tr,
              style: GoogleFonts.poppins(
                fontSize: 16,
                color: Colors.grey[600],
                height: 1.5,
  ...
  Widget _buildStatusCard(BuildContext context, DarkThemeProvider themeChange, String title, bool isCompleted, IconData icon) {
    return Container(
